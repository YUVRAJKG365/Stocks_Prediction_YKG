...
with st.sidebar:
    ...
    # Wrap all inputs in a form to prevent reruns on input changes
    with st.form("forecast_form"):
        ...
        submitted = st.form_submit_button("✨ Generate Smart Forecast", type="primary", use_container_width=True)
